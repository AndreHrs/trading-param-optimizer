...
$\times$ 2~initialisation modes $\times$ 50~runs = 3000~total trials. Two
...
than by the search mechanism. A run count of 50 was chosen as a practical
...
converge to the broken no-trade optimum (fitness near \$1000, the
