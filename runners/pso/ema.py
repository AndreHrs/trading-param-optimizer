...
def run_shared(prices, pop_size=100, max_iter=50, w_max=0.9, w_min=0.4, c1=2, c2=2, max_vel_frac=0.1, seed=None, initial_population=None):
...
def run_independent(prices, pop_size=100, max_iter=50, w_max=0.9, w_min=0.4, c1=2, c2=2, max_vel_frac=0.1, seed=None, initial_population=None):
    def fitness(candidate):
