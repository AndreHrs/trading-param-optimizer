...
def plot_equity_and_purchases(sos, prices, short_signal, long_signal, buy_at, sell_at, title="Train Set Performance", equity_curve=None):
    ...
    if equity_curve is not None:
        ...
        ax_left.plot(sos.history["LE_energy"], label="Best Fitness", color="blue")
        ax_left.set_title("Optimization Convergence (SOS)")
        ax_left.set_xlabel("Iteration")
        ax_left.set_ylabel("Best Fitness (Negative Cash)")
    ax_left.legend()
